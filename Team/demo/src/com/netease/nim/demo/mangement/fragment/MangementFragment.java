 ...
 *
 */
public class MangementFragment extends TFragment implements View.OnClickListener {


    private static final String TAG = "MangementFragment";
    private  View view;
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.btn_custom:
                //添加任务
//                startActivity(new Intent(getContext(), AddActivityActivity.class));
                startActivity(new Intent(getContext(), AddTaskAcitivity.class));
                break;
            case R.id.btn_alter:
                //测试推送
//                ToastHelper.showToast(getContext(),"点击");
//                try {
//                    send();
//
...
//                    e.printStackTrace();
//                }
//                SendMessage(et_msg.getText().toString(),memberUids);
//                sendCustomMsg();
